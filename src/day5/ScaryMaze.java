...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Cheese Maze.jpg"));
		//2. set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(110, 110);
	...
	private void cheese() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("yummy.wav"));
